 ...
 * @author hvn45
 */
public class PnDuty extends javax.swing.JPanel {

    User u;
    final DefaultComboBoxModel ModelEmployee = new DefaultComboBoxModel();
    DutyDAO dao = new DutyDAO();
    ArrayList<com.Nhom5.Entity.Duty> list = new ArrayList<com.Nhom5.Entity.Duty>();
    int rowOT = -1;
    ...
    public Duty getForm() {
        ...
        if(txt_Id.getText().equals("") == false){
             sa.setIdDuty(Integer.valueOf(txt_Id.getText()));
        }
        sa.setNameDuty(txt_Name.getText());
        return sa;
    }

    public void setFormOT(Duty entity) {
        txt_Id.setText(String.valueOf(entity.getIdDuty()));
        txt_Name.setText(entity.getNameDuty());
    }
    ...
    public void fillTable() {
        ...
        list.clear();
        try {
            List<com.Nhom5.Entity.Duty> list = dao.selectAll(); // Đọc dữ liệu từ CSDL
            for (com.Nhom5.Entity.Duty e : list) {
                Object[] data = {
                    e.getIdDuty(),
                    e.getNameDuty(),};
                this.list.add(e);
    ...
    public void update() {
        if (checkInputData() == true) {
            com.Nhom5.Entity.Duty sa = getForm();
            try {
                dao.update(sa);
                this.fillTable();
                clearForm();
    ...
    public void editOT() {
        ...
        com.Nhom5.Entity.Duty ot = dao.selectById_1(idOT);
        this.setFormOT(ot);
    }
