...
public class PnDepartment extends javax.swing.JPanel {
    ...
    ArrayList<com.Nhom5.Entity.Department> list = new ArrayList<com.Nhom5.Entity.Department>();
    int rowOT = -1;
    ...
    public PnDepartment(User entity) {
        initComponents();
        table();
        this.u = entity;
        setInforUser();
    ...
    public Department getForm() {
        ...
        if(txt_Id.getText().equals("") == false){
            sa.setIdDepartment(Integer.valueOf(txt_Id.getText()));
        }
        sa.setNameDepartment(txt_Name.getText());
        return sa;
    }

    public void setFormOT(Department entity) {
        txt_Id.setText(String.valueOf(entity.getIdDepartment()));
        txt_Name.setText(entity.getNameDepartment());
    }
    ...
    public void fillTable() {
        ...
        list.clear();
        try {
            List<com.Nhom5.Entity.Department> list = dao.selectAll(); // Đọc dữ liệu từ CSDL
            for (com.Nhom5.Entity.Department e : list) {
                Object[] data = {
                    e.getIdDepartment(),
                    e.getNameDepartment(),};
                this.list.add(e);
    ...
    public boolean checkInputData() {
        if(txt_Name.getText().equals("") == true){
            MsgBox.alert(this, "Vui lòng nhập tên phòng ban!");
            return false;
        }
        return true;
    }
    ...
    public void update() {
        if (checkInputData() == true) {
            com.Nhom5.Entity.Department sa = getForm();
            try {
                dao.update(sa);
                this.fillTable();
                clearForm();
    ...
    public void editOT() {
        ...
        com.Nhom5.Entity.Department ot = dao.selectById_1(idOT);
        this.setFormOT(ot);
    }
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Tên phòng ban");
